...
class ArtifactoryPlugin implements Plugin<Project> {
  ...
  def void apply(Project project) {
    project.convention.plugins.artifactory = new ArtifactoryPluginInfo()
    ...
    if (!buildListenerAdded) {
      ...
      //Make sure we only add the build listener once
  ...
  private static class ProjectEvaluatedBuildListener extends BuildAdapter {
    ...
    void configureBuildInfoTask(Project project, BuildInfoRecorderTask buildInfoTask, Properties props) {
      ...
      //Make sure each project's buildInfoTask depends on the xecution of its children's buildInfoTask
